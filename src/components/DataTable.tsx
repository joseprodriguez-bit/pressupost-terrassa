      ...
      <table className="w-full text-sm">
        <thead>
          <tr style={{ background: '#1A1A2E' }}>
            ...
            <th className="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider hidden sm:table-cell" style={{ color: 'rgba(255,255,255,0.8)' }}>Àrea</th>
            <th className="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wider" style={{ color: 'rgba(255,255,255,0.8)' }}>Import</th>
          </tr>
        </thead>
        <tbody>
          {items.map((item, i) => (
